...
const JsonBundlerPlugin = require('./plugins/webpack-json-bundler');
...
module.exports = {
  ...
  plugins: [
    ...
    new JsonBundlerPlugin({
      fileInput: '**/translations/*.json',
          omit: /\/translations|\/?components|\/?containers/g,
          rootDirectory: 'src',
      localeDirectory: 'translations/'
    }),
  ],
